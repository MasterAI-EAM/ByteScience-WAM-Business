...
func (api *SampleApi) Edit(ctx *gin.Context, req *dto.Empty) (res *dto.Empty, err error) {
	return
}

func (api *SampleApi) Delete(ctx *gin.Context, req *dto.Empty) (res *dto.Empty, err error) {
	return
}
