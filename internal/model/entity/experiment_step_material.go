...
CREATE TABLE `experiment_step_material` (
  ...
  KEY `idx_experiment_step_material_exp_group_id` (`experiment_material_group_id`)
...
type ExperimentStepMaterial struct {
	...
	ExperimentMaterialGroupID string  `gorm:"primaryKey;index:idx_experiment_step_material_exp_group_id;column:experiment_material_group_id;type:varchar(36);not null" json:"experimentMaterialGroupId"` // 实验材料组ID
